...
import view.Cadastro.CadastroLicitacao;
import view.Edicao.EdicaoLicitacao;

/**
 *
 * @author csqueiroz
 */
public class GestaoLicitacao extends javax.swing.JPanel {

    /**
     * Creates new form GestaoUsuario
     */
    public GestaoLicitacao() {
        initComponents();
        alteraPainelNorte(new CadastroLicitacao(this));
        alteraPainelSouth(new EdicaoLicitacao(this));
