...
import view.Edicao.EdicaoUsuario;

/**
 *
 * @author csqueiroz
 */
public class GestaoUsuario extends javax.swing.JPanel {
    ...
    public GestaoUsuario() {
        initComponents();
        alteraPainelNorte(new CadastroUsuario(this));
        alteraPainelSouth(new EdicaoUsuario(this));
    ...
    private void initComponents() {
        ...
        jPNorth.setBackground(new java.awt.Color(220, 220, 220));
        ...
        jPSouth.setBackground(new java.awt.Color(220, 220, 220));
