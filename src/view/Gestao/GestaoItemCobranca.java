...
import view.Edicao.EdicaoItemCobranca;
 ...
 * @author csqueiroz
 */
public class GestaoItemCobranca extends javax.swing.JPanel {

    /**
     * Creates new form GestaoUsuario
     */
    public GestaoItemCobranca() {
        initComponents();
        alteraPainelNorte(new CadastroItemCobranca());
        alteraPainelSouth(new EdicaoItemCobranca(this));
