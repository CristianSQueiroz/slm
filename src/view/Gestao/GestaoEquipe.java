...
import view.Edicao.EdicaoEquipe;
 ...
 * @author csqueiroz
 */
public class GestaoEquipe extends javax.swing.JPanel {
    ...
    public GestaoEquipe() {
        initComponents();
        alteraPainelNorte(new CadastroEquipe(this));
        alteraPainelSouth(new EdicaoEquipe(this));
