 ...
 * @author csqueiroz
 */
public class EdicaoFuncionario extends javax.swing.JPanel {
     ...
     */
    public EdicaoFuncionario(GestaoFuncionario gF) {
        initComponents();
        carregaLista();
        gestaoFuncionario = gF;
    }
    ...
    private void jButtonExcluir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluir1ActionPerformed
        ...
        if (new FuncionarioDB().excluirFuncionario(Utilidades.validaInt(jTable.getValueAt(jTable.getSelectedRow(), coluna)))) {
            carregaLista();
        }
    ...
    private void carregaPanelCadastro() {
        int coluna = ((JCTable) jTable).getColuna("ID");
        Funcionario f = new FuncionarioDB().getFuncionario(Utilidades.validaInt(jTable.getValueAt(jTable.getSelectedRow(), coluna)));
        ((CadastroFuncionario) gestaoFuncionario.getPanelNorte()).setFuncionario(f);
    }
    ...
    private void carregaLista() {
        ...
        jTable = new JCTable(new FuncionarioDB().getFuncionarios(parametros, null), new NomesColunasContantes().getNomesColunas());
        jSP.setViewportView(jTable);
        jTable.validate();
    }
