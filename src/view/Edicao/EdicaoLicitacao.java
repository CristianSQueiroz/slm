 ...
 * @author csqueiroz
 */
public class EdicaoLicitacao extends javax.swing.JPanel {

    private GestaoLicitacao gestaoLicitacao;

    /**
     * Creates new form EdicaoUsuario
     */
    public EdicaoLicitacao(GestaoLicitacao gestaoLicitacao) {
        initComponents();
        carregaLista();
    ...
    private void jButtonExcluir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluir1ActionPerformed
        ...
        if (new LicitacaoDB().excluirLicitacao(Utilidades.validaInt(jTable.getValueAt(jTable.getSelectedRow(), coluna)))) {
            carregaLista();
        }
    ...
    private void carregaPanelCadastro() {
        int coluna = ((JCTable) jTable).getColuna("ID");
        Licitacao licitacao = new LicitacaoDB().getLicitacao(Utilidades.validaInt(jTable.getValueAt(jTable.getSelectedRow(), coluna)));
        ((CadastroLicitacao) gestaoLicitacao.getPanelNorte()).setLicitacao(licitacao);
    }
    ...
    private void carregaLista() {
        ...
        jTable = new JCTable(new LicitacaoDB().getLicitacoes(parametros, null), new NomesColunasContantes().getNomesColunas());
        jSP.setViewportView(jTable);
        jTable.validate();
    }
